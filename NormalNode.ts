...
const main = async () => {
    try {
        ...
        const dir = '/ip4/35.224.81.61/tcp/1080/p2p/12D3KooWMDMi1kNtv35estDQQngQPpBdZjSjLotPNsFc7m2KpBaD';//await axios.get<DireccionLibp2p>('http://192.168.1.67:8000/directionBoostrapNode');
