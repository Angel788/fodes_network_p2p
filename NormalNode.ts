...
const main = async () => {
    try {
        ...
        const dir = '/ip4/34.122.202.211/tcp/1080/p2p/12D3KooWHSZzdZwuWU4YdqLbJAR9ZJB2CrvPVbxX8sZozh4Dmmzq';//await axios.get<DireccionLibp2p>('http://192.168.1.67:8000/directionBoostrapNode');
