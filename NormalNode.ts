...
const main = async () => {
    try {
        ...
        const dir = '/ip4/35.188.11.88/tcp/1080/p2p/12D3KooWKkjB6gv9kc27EUAqpbm9JWbL7dJJRu7cPeEbytABRs8V';//await axios.get<DireccionLibp2p>('http://192.168.1.67:8000/directionBoostrapNode');
