...
const main = async () => {
    try {
        ...
        const dir = '/ip4/35.188.11.88/tcp/1080/p2p/12D3KooWBWEVn5BfCqG2ycdTYqdFk3TSt4yG5hshMtmMPimGfyTq';//await axios.get<DireccionLibp2p>('http://192.168.1.67:8000/directionBoostrapNode');
