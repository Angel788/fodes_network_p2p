...
const main = async () => {
    try {
        ...
        const dir = '/ip4/34.71.122.91/tcp/1080/p2p/12D3KooWJLmUH7wFoSTqJXTJ5ek9UbqedVPhjbRQ7zbLchhh8PbX';//await axios.get<DireccionLibp2p>('http://192.168.1.67:8000/directionBoostrapNode');
