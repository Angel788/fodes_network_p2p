...
const main = async () => {
    try {
        ...
        const dir = '/ip4/34.122.202.211/tcp/1080/p2p/12D3KooWFiFpATN9HyvhWkTw6B3qZXM4U8iAesdLDrDsfUVtLBik';//await axios.get<DireccionLibp2p>('http://192.168.1.67:8000/directionBoostrapNode');
